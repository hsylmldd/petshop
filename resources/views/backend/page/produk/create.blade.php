...
<div class="page-body">
    <div class="card row">
        ...
        <div class="card-body">
            <form action="/dashboard/produk" method="POST" class="row" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 col-12 row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="bordered shadow">
                            <img src="{{ asset('img-default/default.jpg') }}" alt="Image Preview" class="img-fluid foto-preview2" id="foto-preview2">
                        </div>
                ...
                <div class="col-lg-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="produk" id="produk" class="form-control @error('produk') is-invalid @enderror" value="{{ old('produk') }}">
                        @error('produk')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
